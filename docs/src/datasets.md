...
Points are generated on the unit sphere $S^{n-1} \subset \mathbb{R}^n$:
```math
...
**Mathematical Background:**
Points are generated uniformly in the unit cube $[0,1]^n$:
```math
